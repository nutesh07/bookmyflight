...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> <?php echo $_SESSION['setting_name'] ?> | copyright &copy;all right reserved<a href="" target="_blank"></a></div></div>
        </footer>
